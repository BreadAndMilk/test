define('2.0.0/js/plugins/keypanel/scripts/keyType9.js',function (require, exports, module) {
/**
 * 持仓数字键盘
 */
+ function($) {
	var keyPanelId = "KeyPanel9",
		aKeyPanelHtml = null;
	...
	function createKeyPanelHtml()
	{
		...
		aKeyPanelHtml.push('<div id="KeyPanel9" class="keyword_table">');
		...
		aKeyPanelHtml.push('</tr>');
		aKeyPanelHtml.push('<tr>');
		aKeyPanelHtml.push('<td colspan="2"><a herf="javascript:void(0)">'+b[9]+'</a></td>');
