 ...
 * 信用交易-融资买入
 */
define('trade/scripts/credit/order/financingToBuy.js', function(require, exports, module) {
	var gconfig = $.config;
	var global = gconfig.global;
	var creditOrder = require("creditOrder");
	var _pageId = "#credit_order_financingToBuy ";
	...
	function init(){
		...
		var orderType = "3"; // 1 ，买入  2，卖出  3，融资买入 4，融券卖出  5，普通买入 6，普通卖出 7，买券还券 8，卖券还款
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId+".noicon_text"), function(e){
			$.pageInit("credit/order/financingToBuy","credit/query/financingQuery",{});
			e.stopPropagation();
		});
