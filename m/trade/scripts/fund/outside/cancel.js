 ...
 * 场外基金--撤单
 */
define('trade/scripts/fund/outside/cancel.js', function(require, exports, module) {
    ...
    var _pageId = "#fund_outside_cancel ";
    var userInfo = null;
    var stock_code = "";
    var stock_num = "";  
    var stock_direction = "";
...
//			$.pageInit("stock/stockCancel","account/index",{});
	...
	function queryCancellation(){
		...
		service_fund.queryTodayCancel(param,queryTrustDataCallback,
		{ // 传给接口的json格式数据            
			"isLastReq":true,                
			"isShowWait":true,
			"isShowOverLay":false,
	...
	function cancellation($div){
		...
		service_fund.cancelFundEntrust(param,postCancelOrderCallback);
	}
    //确定撤单回调
