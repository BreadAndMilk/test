 ...
 * 场外基金--历史查询
 */
define('trade/scripts/fund/outside/queryHistory.js', function(require, exports, module) {
    ...
    var _pageId = "#fund_outside_queryHistory ";
    var userInfo = null;
...
//			$.pageInit("stock/stockQueryHistory","stock/stockQuery",{});
	...
	function queryEntrust(){
		...
		service_fund.queryHistoryTrust(param,queryEntrustCallback,
			{
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
	...
	function queryDeal(){
		...
		$(_pageId+ ".no_data").hide();
		service_fund.queryHistoryTrade(param,queryDealCallback,
			{
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
