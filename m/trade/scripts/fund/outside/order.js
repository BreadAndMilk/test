 ...
 * 场外基金-下单
 */
define('trade/scripts/fund/outside/order.js', function(require, exports, module) {
	var common = require("common");
	var gconfig = $.config; 
    var global = gconfig.global;
    var _pageId = "#fund_outside_order ";
	...
	function jumpPageEvent(){
		...
		common.bindStockEvent($(_pageId + '.fund_nav ul li a'));
	}
