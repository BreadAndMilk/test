 ...
 * 港股交易-查询港股公司行为申报
 */
define('trade/scripts/ggt/ggtQueryCompanyHdDeclare.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryCompanyHdDeclare ";
    var userInfo = null;
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryCompanyHdDeclare",prePageCode,{},true);
	}
