 ...
 * 港股交易-历史查询
 */
define('trade/scripts/ggt/ggtQueryHistory.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryHistory ";
    var userInfo = null;
    var time = null;
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("ggt/ggtQueryHistory","ggt/ggtQuery",{},true);
		});
	...
	function queryEntrust(){
		...
		service_ggt.queryHistoryTrust_ggt(param,queryEntrustCallback,
			{
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
...
//		eleHtml+="<span class=\"stat\">"+element.entrust_state_name+"</span>";
//		eleHtml+="<h5>"+element.stock_name+"<span>"+element.entrust_date + " " + element.entrust_time+"</span></h5>";
...
//		eleHtml+="<li>汇&#160;&#160;&#160;率： <span>"+Number(element.exchange_rate).toFixed(price_digit)+"</span></li>";
...
//		eleHtml+="</ul></div>";
	...
	function queryDeal(){
		...
		$(_pageId+ ".no_data").hide();
		service_ggt.queryHistoryTrade_ggt(param,queryDealCallback,
			{
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
...
//		eleHtml+="<h5>"+element.stock_name+"<span>"+element.business_date+" "+element.business_time+"</span></h5>";
//		eleHtml+="<ul class=\"clearfix\">";
...
//		eleHtml+="</ul></div>";
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryHistory",prePageCode,{},true);
	}
