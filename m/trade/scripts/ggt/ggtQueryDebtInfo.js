 ...
 * 港股交易-历史查询
 */
define('trade/scripts/ggt/ggtQueryDebtInfo.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryDebtInfo ";
    var userInfo = null;
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("ggt/ggtQueryDebtInfo","ggt/ggtQuery",{},true);
		});
	}
	...
	function queryEntrustHTML(element){
		...
		eleHtml+="<ul>";
		eleHtml+="<li>未支付金额 <em>"+"500"+"</em></li>";
		eleHtml+="<li>已支付金额 <em>"+"387"+"</em></li>";
		eleHtml+="<li>应支付金额 <em>"+"887"+"</em></li>";
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryDebtInfo",prePageCode,{},true);
	}
