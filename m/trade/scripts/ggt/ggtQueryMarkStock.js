 ...
 * 港股交易-历史查询
 */
define('trade/scripts/ggt/ggtQueryMarkStock.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryMarkStock ";
    var userInfo = null;
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("ggt/ggtQueryMarkStock","ggt/ggtQuery",{},true);
		});
	}
	...
	function queryEntrustHTML(element){
		...
		eleHtml+="</div>";
		eleHtml+="<ul>";
		eleHtml+="<li>整手状态 <em>"+"500"+"</em></li>";
		eleHtml+="<li>零股状态 <em>"+"正常"+"</em></li>";
		eleHtml+="<li>更新日期 <em>"+"2016-06-19"+"</em></li>";
		eleHtml+="</ul>";
		eleHtml+="</div>";
        return eleHtml;
	}
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryMarkStock",prePageCode,{},true);
	}
