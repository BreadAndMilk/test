 ...
 * 历史成交查询
 */
define("project/scripts/stockOption/stockTrade/query/historyDeal",function(require,exports,module){
	var appUtils = require("appUtils"),
		...
		_pageId = "#stockOption_stockTrade_query_historyDeal ";
	/**
	 * 初始化
	 * */
	function init()
	{
		...
		//添加头部
		stock_common.addNavigation(2, 0, 2, 1, "历史成交查询");
...
//			}
	...
	function queryData()
	{
		...
		stock_common.queryDiffTradeDate("0",t,function(data){
			if(data)
			{
				...
				serviceImp.queryHistoryDeal(param,queryCallBack);
			}
		});
	}
	/**
	...
	function BindHeaderEvent()
	{
		stock_common.bindEvent($("#stockOption_header #headerName .icon_back"), function(e){
			appUtils.pageInit("stockOption/stockTrade/query/historyDeal","stockOption/stockTrade/query/mainQuery",{});
			e.stopPropagation();
		});
	}
	/**
