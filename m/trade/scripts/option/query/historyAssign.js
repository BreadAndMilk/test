 ...
 * 历史行权指派查询
 */
define("project/scripts/stockOption/stockTrade/query/historyAssign",function(require,exports,module){
	var appUtils = require("appUtils"),
		...
		_pageId = "#stockOption_stockTrade_query_historyAssign ";
	/**
	 * 初始化
	 * */
	function init()
	{
		...
		//添加头部
		stock_common.addNavigation(2, 0, 2, 1, "历史行权指派查询");
...
//			}
	...
	function queryData()
	{
		...
		stock_common.queryDiffTradeDate("0",t,function(data){
			if(data)
			{
				...
				serviceImp.queryHistoryAssign(param,queryCallBack);
			}
		});
	}
	/**
	...
	function BindHeaderEvent()
	{
		stock_common.bindEvent($("#stockOption_header #headerName .icon_back"), function(e){
			appUtils.pageInit("stockOption/stockTrade/query/historyAssign","stockOption/stockTrade/query/mainQuery",{});
			e.stopPropagation();
		});
	}
	/**
