 ...
 * 历史对账单查询
 */
define("project/scripts/stockOption/stockTrade/query/historyAccountStatement",function(require,exports,module){
	var appUtils = require("appUtils"),
		...
		_pageId = "#stockOption_stockTrade_query_historyAccountStatement ";
	/**
	 * 初始化
	 * */
	function init()
	{
		...
		//添加头部
		stock_common.addNavigation(2, 0, 2, 1, "历史对账单查询");
...
//			}
	...
	function queryData()
	{
		...
		stock_common.queryDiffTradeDate("0",t,function(data){
			if(data)
			{
				...
				serviceImp.queryHistoryAccountStatement(param,queryCallBack);
			}
		});
	}
	/**
	...
	function createHtml(element)
	{
		var eleHtml = "";
		    ...
		    eleHtml += "<li><span>成交日期：</span>"+element.init_date+"</li>";
//		    eleHtml += "<li><span>成交时间：</span>"+element.business_time+"</li>";
			...
			eleHtml += "<li><span>业务类别：</span>"+element.business_name+"</li>";
			...
			eleHtml += "<li><span>标准佣金：</span>"+element.standard_fare0+"</li>";
			eleHtml += "<li><span>佣金:</span>"+element.fare0+"</li>";
			eleHtml += "<li><span>印花税：</span>"+element.fare1+"</li>";
			eleHtml += "<li><span>过户费：</span>"+element.fare2+"</li>";
			eleHtml += "<li><span>结算费：</span>"+element.exchange_fare6+"</li>";
			eleHtml += "<li><span>其他费：</span>"+element.exchange_fare6+"</li>";
			eleHtml += "<li><span>风险金：</span>"+element.exchange_farex+"</li>";
			eleHtml += "<li><span>币种：</span>"+element.money_type_name+"</li>";
	...
	function BindHeaderEvent()
	{
		stock_common.bindEvent($("#stockOption_header #headerName .icon_back"), function(e){
			appUtils.pageInit("stockOption/stockTrade/query/historyAccountStatement","stockOption/stockTrade/query/mainQuery",{});
			e.stopPropagation();
		});
	}
	/**
	...
	module.exports = historyAccountStatement;
});