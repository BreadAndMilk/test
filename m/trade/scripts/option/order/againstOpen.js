 ...
 * 个股期权--下单--备兑开仓
 */
define('trade/scripts/option/order/againstOpen.js', function(require, exports, module) {
	var gconfig = $.config;
	var global = gconfig.global;
	var optionOrder = require("optionOrder");
	var _pageId = "#option_order_againstOpen ";
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId+".noicon_text"), function(e){
			$.pageInit("option/order/againstOpen","option/query/financingQuery",{});
			e.stopPropagation();
		});
