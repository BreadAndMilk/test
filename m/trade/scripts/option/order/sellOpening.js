 ...
 * 个股期权--下单--卖出平仓
 */
define('trade/scripts/option/order/sellOpening.js', function(require, exports, module) {
	var gconfig = $.config;
	var global = gconfig.global;
	var optionOrder = require("optionOrder");
	var _pageId = "#option_order_sellOpening ";
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId+".noicon_text"), function(e){
			$.pageInit("option/order/sellOpening","option/query/financingQuery",{});
			e.stopPropagation();
		});
