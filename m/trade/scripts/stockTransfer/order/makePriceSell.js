 ...
 * 股份转让限价买入
 */
define('trade/scripts/stockTransfer/order/makePriceSell.js',function(require, exports, module) {
	
	var stockTransferOrder = require("stockTransferOrder");
	var common = require("common");
	var _pageId = "#stockTransfer_order_makePriceSell ";
	...
	function init(){
		...
		stockTransferOrder.dataInit(_pageId,4);
    }
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("stockTransfer/order/makePriceSell","stockTransfer/order/order",{},true);
			e.stopPropagation();
		});
