 ...
 * 股份转让查询历史成交和历史委托
 */
define('trade/scripts/stockTransfer/query/queryHistory.js', function(require, exports, module) {
    ...
    var _pageId = "#stockTransfer_query_queryHistory ";
    var userInfo = null;
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageBack("stockTransfer/query/queryHistory","left");
		});
		//页面切换
	...
	function callsQuery(){
		...
		_begin_time=$(_pageId+"#startDate").val();
		_end_time=$(_pageId+"#endDate").val();
	}
	...
	function queryEntrust(){
		...
		var param={				
			...
			service_stockTransfer.queryHistoryEntrust(param,queryEntrustCallback,
				{
				"isLastReq":true,
				"isShowWait":true,
				"isShowOverLay":false,
	...
	function queryDeal(){
		...
		$(_pageId+ ".no_data").hide();
		service_stockTransfer.queryHistoryTrade(param,queryDealCallback,
		    {
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
	 ...
	 */
	function pageBack(){
		$.pageInit("stockTransfer/query/queryHistory","stockTransfer/query/query",{});
	}
