 ...
 * 
 */
define('trade/scripts/ggt/ggtQueryCapitalInfo.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryCapitalInfo ";
    var userInfo = null;
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("ggt/ggtQueryCapitalInfo","ggt/ggtQuery",{},true);
		});
	...
	function queryEntrustHTML(element){
		...
		eleHtml+="<ul>";
		eleHtml+="<li>总  资  产 <em>"+1.65+"</em></li>";
		eleHtml+="<li>可用资金 <em>"+1.46+"</em></li>";
		eleHtml+="<li>划入资金 <em>"+2000+"</em></li>";
		eleHtml+="<li>划出资金 <em>"+200+"</em></li>";
		eleHtml+="<li>实时入账 <em>"+2000.27+"</em></li>";
		eleHtml+="<li>实时出账 <em>"+2000.27+"</em></li>";
		eleHtml+="<li>剩余金额 <em>"+16.23+"</em></li>";
		eleHtml+="<li>清算金额 <em>"+23.78+"</em></li>";
		eleHtml+="<li style=\"width:100%\">实时占有金额 <em>"+3254+"</em></li>";
		eleHtml+="<li style=\"width:100%\">资金科目 <em>"+2.455+"</em></li>";
		eleHtml+="</ul>";
		eleHtml+="</div>";
        return eleHtml;
	}
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryCapitalInfo",prePageCode,{},true);
	}
