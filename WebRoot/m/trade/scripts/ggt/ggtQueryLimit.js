define('trade/scripts/ggt/ggtQueryLimit.js',function(require, exports, module) {
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("ggt/ggtQueryLimit","ggt/ggtQuery",{},true);
		});
	}
	...
	function queryEntrustHTML(element){
		...
		eleHtml+="<ul>";
		eleHtml+="<li>交  易  所 <em>"+"港股通"+"</em></li>";
		eleHtml+="<li>每日初始 <em>"+"27389"+"</em></li>";
		eleHtml+="<li>日中余额 <em>"+"887"+"</em></li>";
		eleHtml+="<li>额度状态 <em>"+"正常"+"</em></li>";
		eleHtml+="<li>交易状态 <em>"+"买卖"+"</em></li>";
		eleHtml+="<li>更新日期 <em>"+"2016-07-10"+"</em></li>";
		eleHtml+="</ul>";
		eleHtml+="</div>";
        return eleHtml;
	}
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryLimit",prePageCode,{},true);
	}
