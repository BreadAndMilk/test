 ...
 * 查询交割单
 */
define('trade/scripts/ggt/ggtQueryExchangeList.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryExchangeList ";
    var userInfo = null;
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("ggt/ggtQueryExchangeList","ggt/ggtQuery",{},true);
		});
	...
	function callsQuery(){
		...
		service_ggt.queryExchangeList(param,queryEntrustCallback,
			{
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
	...
	function queryEntrustHTML(element){
		...
		eleHtml+="<li>清算金额 <em>"+"人民币"+"</em></li>";
		eleHtml+="<li>剩余金额 <em>"+"人民币"+"</em></li>";
		eleHtml+="<li>剩余数量 <em>"+"人民币"+"</em></li>";
		eleHtml+="<li>印  花  税 <em>"+"人民币"+"</em></li>";
		eleHtml+="<li>佣        金 <em>"+"人民币"+"</em></li>";
		eleHtml+="<li>结算汇率 <em>"+"人民币"+"</em></li>";
		eleHtml+="<li>成交编号 <em>"+"人民币"+"</em></li>";
		eleHtml+="<li style=\"width:100%\">币       种 <em>"+"人民币"+"</em></li>";
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryExchangeList",prePageCode,{},true);
	}
