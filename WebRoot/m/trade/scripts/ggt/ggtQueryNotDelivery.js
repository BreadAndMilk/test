 ...
 * 
 */
define('trade/scripts/ggt/ggtQueryNotDelivery.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryNotDelivery ";
    var userInfo = null;
	...
	function queryEntrustHTML(element){
		...
		eleHtml+="</div>";
		eleHtml+="<ul>";
		eleHtml+="<li>委托价格 <em>"+1.65+"</em></li>";
		eleHtml+="<li>成交价格 <em>"+1.46+"</em></li>";
		eleHtml+="<li>委托数量 <em>"+2000+"</em></li>";
		eleHtml+="<li>成交数量 <em>"+200+"</em></li>";
		eleHtml+="<li>成交金额 <em>"+2000.27+"</em></li>";
		eleHtml+="<li>清算金额 <em>"+2000.27+"</em></li>";
		eleHtml+="<li>印  花  税 <em>"+16.23+"</em></li>";
		eleHtml+="<li>佣        金 <em>"+23.78+"</em></li>";
		eleHtml+="<li>成交编号 <em>"+3254+"</em></li>";
		eleHtml+="<li>结算费率 <em>"+2.455+"</em></li>";
		eleHtml+="<li>币       种 <em>"+"港币"+"</em></li>";
		eleHtml+="<li>业务名称 <em>"+""+"</em></li>";
		eleHtml+="</ul>";
		eleHtml+="</div>";
        return eleHtml;
	}
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryNotDelivery",prePageCode,{},true);
	}
