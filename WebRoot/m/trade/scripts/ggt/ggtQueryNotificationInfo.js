 ...
 * 查询港股通知信息
 */
define('trade/scripts/ggt/ggtQueryNotificationInfo.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryNotificationInfo ";
    var userInfo = null;
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("ggt/ggtQueryNotificationInfo","ggt/ggtQuery",{},true);
		});
	...
	function callsQuery(){
		...
		service_ggt.queryNotifyInfo(param,queryEntrustCallback,
			{
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
	...
	function queryEntrustHTML(element){
		...
		eleHtml+="</div>";
		eleHtml+="<ul>";
		eleHtml+="<li>流通类型 <em>"+"无限售流通"+"</em></li>";
		eleHtml+="<li>权益类别 <em>"+"红利"+"</em></li>";
		eleHtml+="<li>挂牌年份 <em>"+"2015"+"</em></li>";
		eleHtml+="<li>权益次数 <em>"+2+"</em></li>";
		eleHtml+="<li>当前价格 <em>"+2000.27+"</em></li>";
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryNotificationInfo",prePageCode,{},true);
	}
