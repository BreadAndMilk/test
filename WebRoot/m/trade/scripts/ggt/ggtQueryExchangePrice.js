 ...
 * 价差查询
 */
define('trade/scripts/ggt/ggtQueryExchangePrice.js',function(require, exports, module) {
    ...
    var _pageId = "#ggt_ggtQueryExchangePrice ";
    var userInfo = null;
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("ggt/ggtQueryExchangePrice","ggt/ggtQuery",{},true);
		});
	}
	...
	function callsQuery(){
		...
		service_ggt.queryPrice(param,queryEntrustCallback,
			{
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
	...
	function queryEntrustHTML(element){
		...
		eleHtml+="<ul>";
		eleHtml+="<li>交  易  所 <em>"+element.exchange_type+"</em></li>";
		eleHtml+="<li>证券类别 <em>"+element.stock_type+"</em></li>";
		eleHtml+="<li>价格上限 <em>"+element.high_price+"</em></li>";
		eleHtml+="<li>价格下限 <em>"+element.low_price+"</em></li>";
		eleHtml+="<li>价位(港元)<em>"+element.trade_price+"</em></li>";
	...
	function pageBack(){
		...
		$.pageInit("ggt/ggtQueryExchangePrice",prePageCode,{},true);
	}
