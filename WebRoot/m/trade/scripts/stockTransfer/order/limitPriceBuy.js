 ...
 * 股份转让限价买入
 */
define('trade/scripts/stockTransfer/order/limitPriceBuy.js',function(require, exports, module) {
	
	var stockTransferOrder = require("stockTransferOrder");
	var common = require("common");
	var _pageId = "#stockTransfer_order_limitPriceBuy ";
	...
	function init(){
		...
		stockTransferOrder.dataInit(_pageId,1);
    }
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("stockTransfer/order/limitPriceBuy","stockTransfer/order/order",{},true);
			e.stopPropagation();
		});
