 ...
 * 港股交易-撤单
 */
define('trade/scripts/stockTransfer/order/cancel.js',function(require, exports, module) {
    ...
    var _pageId = "#stockTransfer_order_cancel ";
    var entrustNo = ""; //撤单编号
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId + ".top_title .icon_back"), function(e){
			$.pageInit("stockTransfer/order/cancel","stockTransfer/order/order",{},true);
		});
		//撤单取消
...
//  	eleHtml+="</div>";
		...
		eleHtml+="<div class=\"title\"><span class=\""+css+"\">"+entrust_name+"</span><h5><em>"+element.stock_name+"</em><small>"+element.stock_code+"</small></h5><span class=\"time\">"+element.entrust_time+"</span></div>"
       	...
       	eleHtml+="<li>成交价 <span id=\"businessPrice\">"+Number(element.business_price).toFixed(price_digit)+"</span></li>";
	 ...
	 */
	function pageBack(){
		$.pageInit("stockTransfer/order/cancel","stockTransfer/order/order",{});
	}
