 ...
 * 普通交易-历史查询
 */
define('trade/scripts/stock/stockQueryHistory.js', function(require, exports, module) {
	var common = require("common");
	var commonFunc = require("commonFunc");
	var gconfig = $.config;
	var global = gconfig.global;
	var service_stock = require("service_stock");
    var _pageId = "#stock_stockQueryHistory ";
    var userInfo = null;
...
//			$.pageInit("stock/stockQueryHistory","stock/stockQuery",{});
	...
	function queryDealHTML(element){
        ...
        eleHtml+="<td><span>"+Number(element.business_balance).toFixed(2)+"</span></td>";
