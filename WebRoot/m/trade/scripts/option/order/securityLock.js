 ...
 * 个股期权--下单--证券锁定
 */
define("project/scripts/stockOption/stockTrade/order/securityLock", function(require,exports,module){
	var appUtils = require("appUtils"),
		...
		bond_type = null,
		userInfo = null,
		_pageId = "#stockOption_stockTrade_order_securityLock ";
	...
	function init()
	{
		...
		stock_common.addNavigation(1, 0, 2, 1,"证券锁定");
...
//				$(_pageId+" #stockName").attr("value",results[0].stock_name);
	...
	function order_bindPageEvent()
	{
		stock_common.bindEvent($("#stockOption_header #headerName .icon_back"), function(e){
			appUtils.pageInit("stockOption/stockTrade/order/securityLock","stockOption/stockTrade/order/homePage",{});
			e.stopPropagation();
		});
		//全部
