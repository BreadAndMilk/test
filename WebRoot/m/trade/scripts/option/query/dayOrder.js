 ...
 * 查询当日委托
 */
define("project/scripts/stockOption/stockTrade/query/dayOrder",function(require,exports,module){
	var appUtils = require("appUtils"),
		...
		_pageId = "#stockOption_stockTrade_query_dayOrder ";
	/**
	 * 初始化
	 * */
	function init()
	{
		...
		//添加头部
		stock_common.addNavigation(2, 0, 2, 1, "当日委托查询");
	...
	function queryData()
	{
		...
		serviceImp.queryDayOrder(param,queryCallBack);
	}
	/**
	 * 当日委托数据方法
	...
	function BindHeaderEvent()
	{
		stock_common.bindEvent($("#stockOption_header #headerName .icon_back"), function(e){
			appUtils.pageInit("stockOption/stockTrade/query/dayOrder","stockOption/stockTrade/query/mainQuery",{});
			e.stopPropagation();
		});
	}
	/**
