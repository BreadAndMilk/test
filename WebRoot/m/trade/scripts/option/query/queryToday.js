 ...
 * 普通交易-今日查询
 */
define('trade/scripts/option/query/queryToday.js', function(require, exports, module) {
    ...
    var _pageId = "#option_query_queryToday ";
    var userInfo = null;
...
//			$.pageInit("option/query/queryToday","option/query/stockQuery",{});
	...
	function queryEntrust(){
		...
		var param={				
			...
			service_stock.queryTodayTrust(param,queryEntrustCallback,
				{
				"isLastReq":true,
				"isShowWait":true,
				"isShowOverLay":false,
	...
	function queryEntrustHTML(element,i){
		...
		var eleHtml = "";
      	eleHtml+="<tr>";
        eleHtml+="<td><strong>"+element.stock_name+"</strong><small>"+element.entrust_time+"</small></td>";
	...
	function queryDeal(){
		...
		$(_pageId+ ".no_data").hide();
		service_stock.queryTodayTrade(param,queryDealCallback,
		    {
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
	...
	function queryDealHTML(element,i){
		...
		var eleHtml = "";
      	eleHtml+="<tr>";
        eleHtml+="<td><strong>"+element.stock_name+"</strong><small>"+element.business_time+"</small></td>";
