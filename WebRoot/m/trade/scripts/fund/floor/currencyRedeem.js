 ...
 * 普通交易-查询
 */
define('trade/scripts/fund/floor/currencyRedeem.js', function(require, exports, module) {
	var common = require("common");
	var gconfig = $.config; 
    var global = gconfig.global;
    var _pageId = "#fund_floor_currencyRedeem ";
	...
	function submitOrderFund(){
		...
		var tipStrArray = [];
		tipStrArray.push(["基金名称", fundInfo.fund_name]);
		tipStrArray.push(["基金代码 ", fundInfo.fund_code]);
		...
		common.iConfirm("下单确定",tipStr,function success(){
			...
			service_fund.submitOrder(param,function(data){
				if(data.error_no ==0){
