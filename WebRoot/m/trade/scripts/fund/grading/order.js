 ...
 * 分级基金-下单
 */
define('trade/scripts/fund/grading/order.js', function(require, exports, module) {
	var common = require("common");
	var gconfig = $.config; 
    var global = gconfig.global;
    var _pageId = "#fund_grading_order ";
	...
	function jumpPageEvent(){
		...
		common.bindStockEvent($(_pageId + '.fund_nav2 ul li a'));
	}
