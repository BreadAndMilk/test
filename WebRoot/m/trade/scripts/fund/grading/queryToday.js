 ...
 * 分级基金-今日查询
 */
define('trade/scripts/fund/grading/queryToday.js', function(require, exports, module) {
    ...
    var _pageId = "#fund_grading_queryToday ";
    var userInfo = null;
...
//			$.pageInit("stock/stockQueryToday","stock/stockQuery",{});
	...
	function queryEntrust(){
		...
		var param={				
			...
			service_fund.gradingDayCommission(param,queryEntrustCallback,
				{
				"isLastReq":true,
				"isShowWait":true,
				"isShowOverLay":false,
	...
	function queryDeal(){
		...
		$(_pageId+ ".no_data").hide();
		service_fund.gradingDayDeal(param,queryDealCallback,
		    {
			"isLastReq":true,
			"isShowWait":true,
			"isShowOverLay":false,
