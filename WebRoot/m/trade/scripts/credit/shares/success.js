 ...
 * 新股-中签查询
 */
define('trade/scripts/credit/shares/success.js',function(require, exports, module) {
	var gconfig = $.config;
	...
	var isShowWait = true;
	var _pageId = "#credit_shares_success ";
	var userInfo =null;
	var whichPage ="";
	var witchAccount = "";
	...
	function queryAchiveData(){
		...
		service_stock.querySuccessData(param,querySuccessDataCallBack,
		{  //传给接口的json格式数据            
			"isLastReq":true,                
	...
	function createHtml(element){
        ...
        eleHtml += "<li>中签数量<span>"+Number(element.occur_amount)+"</span></li>";
        eleHtml += "<li>成交价格<span>"+Number(element.business_price).toFixed(3)+"</span></li>";
        eleHtml += "<li>成交金额<span>"+Number(element.business_balance).toFixed(3)+"</span></li>";
