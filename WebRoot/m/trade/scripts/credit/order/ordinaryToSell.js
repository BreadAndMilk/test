 ...
 * 信用交易-普通卖出
 */
define('trade/scripts/credit/order/ordinaryToSell.js', function(require, exports, module) {
	var gconfig = $.config;
	var global = gconfig.global;
	var creditOrder = require("creditOrder");
	var _pageId = "#credit_order_ordinaryToSell ";
	...
	function init(){
		...
		var orderType = "6"; // 1 ，买入  2，卖出  3，融资买入 4，融券卖出  5，普通买入 6，普通卖出 7，买券还券 8，卖券还款
	...
	function bindPageEvent(){
		...
		$.bindEvent($(_pageId+".noicon_text"), function(e){
			$.pageInit("credit/order/ordinaryToSell","credit/query/financingQuery",{});
			e.stopPropagation();
		});
